...
export default function ScientistCard({ scientist, featured = false }: ScientistCardProps) {
  if (featured) {
    return (
      <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-4 text-sm leading-relaxed">{scientist.achievement}</p>
          ...
          <div className="flex items-center justify-between text-sm">
            <div className="flex flex-col">
              ...
              {scientist.publications && (
                <span className="text-gray-400 text-xs">{scientist.publications} publicações</span>
              )}
            </div>
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 p-4 border border-gray-100 hover:border-primary/20">
      ...
      <div className="flex items-center justify-between">
        {scientist.publications && (
          <span className="text-gray-400 text-xs">{scientist.publications} pub.</span>
        )}
