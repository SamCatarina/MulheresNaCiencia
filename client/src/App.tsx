      ...
      <footer className="bg-neutral-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-xl font-bold">Women in Science</span>
              </div>
              <p className="text-gray-400">
                Celebrating and supporting women scientists worldwide through visibility, connection, and advocacy.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Explore</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Featured Scientists</a></li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Women in Science. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
